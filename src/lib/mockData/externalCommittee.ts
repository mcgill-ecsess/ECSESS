...
export const externalCommittee: CouncilMember[] = [
	{
		name: 'Noah Bergeron',
		email: 'noah.bergeron@mail.mcgill.ca',
		position: 'External Committee Chair',
		positionDescription:
			'Leads outreach efforts and represents ECSESS in relationships with industry partners, sponsors, and other student societies.',
		image: '',
		yearProgram: 'U3 Electrical Engineering'
	},
	{
		name: 'Emily Zhang',
