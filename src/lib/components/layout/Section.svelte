<script>
	/**
	 * Transparent layout band — height hugs content with viewport-proportional padding.
	 * When it is the page's only section, layout flex-1 stretches it to fill the viewport.
	 * Props:
